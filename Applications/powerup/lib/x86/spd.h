...
// addr  len  bit    desc
// 00    1    [7]    reserved
//            [6:4]  SPD bytes total (0=undef, 1=256, 2=512)
//            [3:0]  SPD bytes used  (0=undef, 1=128, 2=256, 3=384, 4=512)
// 01    1    [7:4]  SPD major revision, typically 1.0 or 1.1
//            [3:0]  SPD minor revision
// 02    1    [7:0]  DRAM device type
//                   0=reserved, 1=fast page mode, 2=EDO, 3=pipelined nibble
//                   4=SDRAM, 5=ROM, 6=DDR SGRAM, 7=DDR SDRAM
//                   8=DDR2 SDRAM, 9=DDR2 SDRAM FB-DIMM, 10=DDR2 SDRAM FB-DIMM PROBE, 11=DDR3 SRAM
//                   12=DDR4 SDRAM, 13=reserved, 14=DDR4E, 15=LPDDR3
//                   16=LPDDR4
// 03    1    [7]    hybrid
//            [6:4]  hybrid media
//            [3:0]  base module type  (0=undef, 1=128, 2=256, 3=384, 4=512)

//=============================================================================
//  DDR3 SPD
//=============================================================================
// addr  len  bit    desc
// 00    1    [7]    exclude serial from CRC
//            [6:4]  SPD bytes total (undef/256)
//            [3:0]  SPD bytes used  (undef/128/176/256)
// 01    1    [7:4]  SPD major revision, typically 1.0 or 1.1
//            [3:0]  SPD minor revision
// 02    1    [7:0]  Basic memory type (11=DDR3 SDRAM) type of RAM chips
// 03    1    [7:4]  -
//            [3:0]  module type, 2=un-buffered DIMM, 3=SO-DIMM...
// 04    1    [7]    -
//            [6:4]  bank address bits-3
//            [3:0]  log2(bits per chip)-28
// 05    1    [7:6]  -
//            [5:3]  row address bits-12
//            [2:0]  column address bits-9
// 06    1    [7:3]  -
//            [2]    1.25V
//            [1]    1.35V
//            [0]    not 1.5V, modules voltages supported, 1.5V is default
// 07    1    [7:6]  -
//            [5:3]  ranks-1
//            [2:0]  log2(I/O bits/chip)-2, module organization
// 08    1    [7:5]  -
//            [4:3]  ECC bits (001=8)
//            [2:0]  log2(data bits)-3
// 09    1    [7:4]  dividend, picoseconds (1-15)
//            [3:0]  divisor, picoseconds  (1-15)
// 0A    1    [7:0]  dividend, nanoseconds (1-255)
// 0B    1    [7:0]  divisor, nanoseconds  (1-255)
// 0C    1    [7:0]  minimum cycle time tck min
// 0D    1    [7:0]  -
// 0E    1    [7:0]  cas latency supported bit[11:4]
// 0F    1    [7]    -
//            [6:0]  cas latency supported bit[18:12]
// 10    1    [7:0]  min cas latency time (t-AA)
// 11    1    [7:0]  min write recovery time (t-WR)
// 12    1    [7:0]  min ras-to-cas delay time (t-RCD)
// 13    1    [7:0]  min row-to-row active delay time (t-RRD)
// 14    1    [7:0]  min row precharge time (t-RP)
// 15    1    [7:4]  bit[11:8] of (t-RC) min
//            [3:0]  bit[11:8] of (t-RAS) min
// 16    1    [7:0]  min active to time, bit[7:0] of (t-RAS)
// 17    1    [7:0]  min active to active/refresh, bit[7:0] of (t-RC)
// 18    1    [7:0]  min refresh recovery delay,   bit[7:0] of (t-RFC)

// todos.........

// 3F    -    module-specific rection
// 74   54    
// 75    1    [7:0]  LSB of manufacturer ID
// 76    1    [7:0]  MSB of manufacturer ID
// 77    1    [7:0]  module manufacturing location (vendor-specific code)
// 78    1    [7:4]  tens of years (BCD)
//            [3:0]  years (BCD)
// 79    1    [7:4]  tens of weeks (BCD)
//            [3:0]  weeks (BCD)

// 7A    4    module serial number
// 7E    2    SPD CRC-16 (included 0~116 or 0~125 depends byte0 bit[7]
// 80   18    module part number (model name)
// 92    2    module revision code
// 94    2    DRAM manufacturer ID
// 96   26    manufacturer specific-data
// B0
//---- 176    bytes for DDR3 SPD
...
#define SPD_RAM_TYPE_RSVD2		0x0D	// reserved
#define SPD_RAM_TYPE_DDR4E		0x0E	// DDR4E SDRAM
#define SPD_RAM_TYPE_LPDDR3		0x0F	// LPDDR3 SDRAM
#define SPD_RAM_TYPE_LPDDR4		0x10	// LPDDR4 SDRAM
#define SPD_RAM_TYPE_LPDDR4X	0x11	// LPDDR4X SDRAM
#define SPD_RAM_TYPE_DDR5		0x12	// DDR5 SDRAM
#define SPD_RAM_TYPE_LPDDR5		0x13	// LPDDR5 SDRAM
...
#define SPD_DDR3_MOD_UNDEF		0x00

#define SPD_DDR4_MOD_EXT		0x00
#define SPD_DDR4_MOD_RDIMM		0x01
#define SPD_DDR4_MOD_UDIMM		0x02
#define SPD_DDR4_MOD_SODIMM		0x03
#define SPD_DDR4_MOD_LRDIMM		0x04
#define SPD_DDR4_MOD_MINIRDIMM	0x05
#define SPD_DDR4_MOD_MINIUDIMM	0x06
#define SPD_DDR4_MOD_72SORDIMM	0x08
#define SPD_DDR4_MOD_72SOUDIMM	0x09
#define SPD_DDR4_MOD_16SODIMM	0x0C
#define SPD_DDR4_MOD_32SODIMM	0x0D
#define SPD_DDR4_MOD_UNKNOWN	0xFF
...
#define SPD_MANU_ID_MICRON			0x2C00	// bank 1,  code 2Ch
#define SPD_MANU_ID_HYNIX			0xAD00	// bank 1,  code ADh
#define SPD_MANU_ID_SAMSUNG			0xCE00	// bank 1,  code CEh
#define SPD_MANU_ID_TRANSCEND		0x4F01	// bank 2,  code 4Fh
#define SPD_MANU_ID_APACER			0x7A01	// bank 2,  code 7Ah
#define SPD_MANU_ID_FOXCONN			0x7C01	// bank 2,  code 7Ch
#define SPD_MANU_ID_SMART_MODULAR	0x9401	// bank 2,  code 94h
#define SPD_MANU_ID_KINGSTON		0x9801	// bank 2,  code 98h
#define SPD_MANU_ID_CORSAIR			0x9E02	// bank 3,  code 9Eh
#define SPD_MANU_ID_ELPIDA			0xFE02	// bank 3,  code FEh
#define SPD_MANU_ID_NANYA			0x0B03	// bank 4,  code 0Bh
#define SPD_MANU_ID_KINGMAX			0x2503	// bank 4,  code 25h
#define SPD_MANU_ID_RAMAXEL			0x4304	// bank 5,  code 43h
#define SPD_MANU_ID_ADATA			0xCB04	// bank 5,  code CBh
#define SPD_MANU_ID_TEAM_GROUP		0xEF04	// bank 5,  code EFh
#define SPD_MANU_ID_PQI				0x3E05	// bank 6,  code 3Eh
#define SPD_MANU_ID_INNODISK		0xF106	// bank 7,  code F1h
#define SPD_MANU_ID_UNIFOSA			0x0707	// bank	8,  code 07h
#define SPD_MANU_ID_DSL				0xF708	// bank 9,  code F7h
#define SPD_MANU_ID_ADVANTECH		0xC80A	// bank 11, code C8h
...
//  extern
//=============================================================================
extern spd_name_t	spd_ram_type_table[19];
extern spd_name_t	spd_manu_id_table[22];
