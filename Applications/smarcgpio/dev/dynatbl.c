...
void dyna_getDevStr(eDynclDevNo did, char * str)
{
    ...
    case DDevNo_AltGpio00:
        strcpy(str, "OEMGPIO0"); break;
    case DDevNo_AltGpio01:
        strcpy(str, "OEMGPIO1"); break;
    case DDevNo_AltGpio02:
        strcpy(str, "OEMGPIO2"); break;
    case DDevNo_AltGpio03:
        strcpy(str, "OEMGPIO3"); break;
    case DDevNo_AltGpio04:
        strcpy(str, "OEMGPIO4"); break;
    case DDevNo_AltGpio05:
        strcpy(str, "OEMGPIO5"); break;
    case DDevNo_AltGpio06:
        strcpy(str, "OEMGPIO6"); break;
    case DDevNo_AltGpio07:
        strcpy(str, "OEMGPIO7"); break;
    case DDevNo_Btn0:
        strcpy(str, "Button0"); break;
    case DDevNo_Btn1:
        strcpy(str, "Button1"); break;
    case DDevNo_Btn2:
        strcpy(str, "Button2"); break;
    case DDevNo_Btn3:
        strcpy(str, "Button3"); break;
    case DDevNo_Btn4:
        strcpy(str, "Button4"); break;
    case DDevNo_Btn5:
        strcpy(str, "Button5"); break;
    case DDevNo_Btn6:
        strcpy(str, "Button6"); break;
    case DDevNo_Btn7:
        strcpy(str, "Button7"); break;
    case DDevNo_BriOnOff1:
        strcpy(str, "LVDS_On_Off1"); break;
    case DDevNo_BriOnOff2:
        strcpy(str, "LVDS_On_Off2"); break;
    case DDevNo_PowerLed:
        strcpy(str, "Power_LED"); break;
    case DDevNo_BatLedG:
        strcpy(str, "Battery_Led_Green"); break;
    case DDevNo_OemLed0:
        strcpy(str, "OEM_LED0"); break;
    case DDevNo_OemLed1:
        strcpy(str, "OEM_LED1"); break;
    case DDevNo_OemLed2:
        strcpy(str, "OEM_LED2"); break;
    case DDevNo_BatLedR:
        strcpy(str, "Battery_Led_Red"); break;
    //PWM
    case DDevNo_CPUFAN_2P:
        strcpy(str, "CPUFan_2P"); break;
    case DDevNo_CPUFAN_4P:
        strcpy(str, "CPUFan_4P"); break;
    case DDevNo_SYSFAN1_2P:
        strcpy(str, "SYSFan1_2P"); break;
    case DDevNo_SYSFAN1_4P:
        strcpy(str, "SYSFan1_4P"); break;
    case DDevNo_SYSFAN2_2P:
        strcpy(str, "SYSFan2_2P"); break;
    case DDevNo_SYSFAN2_4P:
        strcpy(str, "SYSFan2_4P"); break;
    case DDevNo_PWMBRIGHTNESS:
        strcpy(str, "LVDS1_PWM"); break;
    case DDevNo_PWMBEEP:
        strcpy(str, "BEEP_PWM"); break;
    case DDevNo_PWMBRIGHTNESS2:
        strcpy(str, "LVDS2_PWM"); break;
    //SMBUS
    case DDevNo_SMBOEM0:
        strcpy(str, "SMBus_OEM0"); break;
    case DDevNo_SMBOEM1:
        strcpy(str, "SMBus_OEM1"); break;
    case DDevNo_SMBOEM2:
        strcpy(str, "SMBus_OEM2"); break;
    case DDevNo_SMBEEPROM:
        strcpy(str, "SMB_EEPRom"); break;
    case DDevNo_SMBTHERMAL0:
        strcpy(str, "SMB_Thermal0"); break;
    case DDevNo_SMBTHERMAL1:
        strcpy(str, "SMB_Thermal1"); break;
    case DDevNo_SMBSecurityEEP:
        strcpy(str, "Security_EEPRom"); break;
    case DDevNo_I2COEM:
        strcpy(str, "I2C_OEM0"); break;
    case DDevNo_SMBEEP2K:
        strcpy(str, "SMB_EEPR_>2K"); break;
    case DDevNo_OEMEEP:
        strcpy(str, "OEM_EEPRom"); break;
    case DDevNo_OEMEEP2K:
        strcpy(str, "OEM_EEPRom_>2K"); break;
    case DDevNo_PECI:
        strcpy(str, "PECI"); break;
    case DDevNo_SMBOEM3:
        strcpy(str, "SMBus_OEM3"); break;
    case DDevNo_SMLINK:
        strcpy(str, "SMLink"); break;
    case DDevNo_SMBSlv:
        strcpy(str, "SMB_Slave_Mode"); break;
    //DAC DEVICE
    case DDevNo_DACSPEAKER:
        strcpy(str, "Speaker_DAC"); break;
    //smart battery
    case DDevNo_SmartBat1:
        strcpy(str, "Battery1"); break;
    case DDevNo_SmartBat2:
        strcpy(str, "Battery2"); break;
    //ADC Device
    case DDevNo_ADCCMOSBAT:
    case DDevNo_ADCCMOSBATx2:
    case DDevNo_ADCCMOSBATx10:
        strcpy(str, "CMOS_Battery_Volt"); break;
    case DDevNo_ADCBAT:
    case DDevNo_ADCBATx2:
    case DDevNo_ADCBATx10:
        strcpy(str, "Battery_Volt"); break;
    case DDevNo_ADC5VS0:
    case DDevNo_ADC5VS0x2:
    case DDevNo_ADC5VS0x10:
        strcpy(str, "5VS0_Volt"); break;
    case DDevNo_ADC5VS5:
    case DDevNo_ADC5VS5x2:
    case DDevNo_ADC5VS5x10:
        strcpy(str, "5VS5_Volt"); break;
    case DDevNo_ADC33VS0:
    case DDevNo_ADC33VS0x2:
    case DDevNo_ADC33VS0x10:
        strcpy(str, "3.3VS0_Volt"); break;
    case DDevNo_ADC33VS5:
    case DDevNo_ADC33VS5x2:
    case DDevNo_ADC33VS5x10:
        strcpy(str, "3.3VS5_Volt"); break;
    case DDevNo_ADC12VS0:
    case DDevNo_ADC12VS0x2:
    case DDevNo_ADC12VS0x10:
        strcpy(str, "12VS0_Volt"); break;
    case DDevNo_ADCVCOREA:
    case DDevNo_ADCVCOREAx2:
    case DDevNo_ADCVCOREAx10:
        strcpy(str, "VCoreA_Volt"); break;
    case DDevNo_ADCVCOREB:
    case DDevNo_ADCVCOREBx2:
    case DDevNo_ADCVCOREBx10:
        strcpy(str, "VCoreB_Volt"); break;
    case DDevNo_ADCDC:
    case DDevNo_ADCDCx2:
    case DDevNo_ADCDCx10:
        strcpy(str, "DC_Volt"); break;
    case DDevNo_ADCDCSTBY:
    case DDevNo_ADCDCSTBYx2:
    case DDevNo_ADCDCSTBYx10:
        strcpy(str, "DCSTBY_Volt"); break;
    case DDevNo_ADCDCOther:
    case DDevNo_ADCDCOtherx2:
    case DDevNo_ADCDCOtherx10:
        strcpy(str, "Other_Volt"); break;
    case DDevNo_ADCCurrent:
        strcpy(str, "Current_ADC"); break;
    //watchdog type
    case DDevNo_WDIRQ:
        strcpy(str, "IRQ"); break;
    case DDevNo_WDNMI:
        strcpy(str, "NMI"); break;
    //Fan Tacho
    case DDevNo_CPUFanSpeed0:
        strcpy(str, "CPU0_FanSpeed"); break;
    case DDevNo_SYSFanSpeed0:
        strcpy(str, "SYS0_FanSpeed"); break;
    case DDevNo_SYSFanSpeed1:
        strcpy(str, "SYS1_FanSpeed"); break;
    //Temperature
    case DDevNo_Temperature_CPU0:
        strcpy(str, "CPU_Temperature0"); break;
    case DDevNo_Temperature_CPU1:
        strcpy(str, "CPU_Temperature1"); break;
    case DDevNo_Temperature_SYS0:
        strcpy(str, "System_Temperature0"); break;
    case DDevNo_Temperature_SYS1:
        strcpy(str, "System_Temperature1"); break;
    //Thermal Protect type
    case DDevNo_TherPro_ShutDown:
        strcpy(str, "TmlPro_Shutdown"); break;
    case DDevNo_TherPro_PwrOff:
        strcpy(str, "TmlPro_Pwroff"); break;
    case DDevNo_TherPro_Throttle:
        strcpy(str, "TmlPro_Throttle"); break;
    //watchdog type
    case DDevNo_WD_WRST:
        strcpy(str, "Watchdog_WarmRST"); break;
    case DDevNo_WD_CRST:
        strcpy(str, "Watchdog_ColdRST"); break;
    case DDevNo_WD_SCI:
        strcpy(str, "Watchdog_SCI"); break;
    case DDevNo_WD_IRQNMI:
        strcpy(str, "Watchdog_IRQ/NMI"); break;
    case DDevNo_WD_WDPin:
        strcpy(str, "Watchdog_Pin"); break;
    //EEPRom software write protect function
    case DDevNo_EEPRom_WPF:
        strcpy(str, "SEEPRom_WriteProtect"); break;
	//GPIO
    case DDevNo_AltGpio08:
        strcpy(str, "OEMGPIO8"); break;
	case DDevNo_AltGpio09:
        strcpy(str, "OEMGPIO9"); break;
	case DDevNo_AltGpio10:
        strcpy(str, "OEMGPIO10"); break;
	case DDevNo_AltGpio11:
        strcpy(str, "OEMGPIO11"); break;
	case DDevNo_AltGpio12:
        strcpy(str, "OEMGPIO12"); break;
	case DDevNo_AltGpio13:
        strcpy(str, "OEMGPIO13"); break;
	case DDevNo_AltGpio14:
        strcpy(str, "OEMGPIO14"); break;
	case DDevNo_AltGpio15:
        strcpy(str, "OEMGPIO15"); break;
    }
}
/*===========================================================
...
void dyna_getTypeStr(eDynclDevType type, char * str)
{
    ...
    switch (type)
    {
        ...
        case DDevType_GPIO:
            strcpy(str, "GPIO"); break;
        case DDevType_OEMGPIO:
            strcpy(str, "GPIO"); break;
        case DDevType_ADC:
            strcpy(str, "ADC"); break;
        case DDevType_DAC:
            strcpy(str, "DAC"); break;
        case DDevType_TACHO:
            strcpy(str, "TACHO"); break;
        case DDevType_PWM:
            strcpy(str, "PWM"); break;
        case DDevType_SMB:
            strcpy(str, "SMB/I2C"); break;
        case DDevType_Battery:
            strcpy(str, "Battery"); break;
        case DDevType_IRQNMI:
            strcpy(str, "IRQ/NMI"); break;
        case DDevType_Func:
            strcpy(str, "Function"); break;
        default:
