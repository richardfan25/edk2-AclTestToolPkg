...
void tml_getTypeStr(eTMLType type, char *data)
{
    ...
    switch (type) {
    case TMLType_1L:
        strcpy(data, "SYS0_Temperature"); break;
    case TMLType_1R:
        strcpy(data, "CPU0_Temperature"); break;
    case TMLType_2L:
        strcpy(data, "SYS1_Temperature"); break;
    case TMLType_2R:
        strcpy(data, "CPU1_Temperature"); break;
    default:
        strcpy(data, "Unknown"); break;
    }
}
