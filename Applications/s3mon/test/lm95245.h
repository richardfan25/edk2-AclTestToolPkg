...
#define LM_ERR_IC_NOT_FOUND		0x8001				// Input address is not lm95245 smbus address
#define LM_ERR_GET_RO_REG		0x8002				// Input register is read only
#define LM_ERR_GET_WO_REG		0x8003				// Input register is write only
#define LM_ERR_GET_UNKNOWN_REG	0x8004				// Input register is unsupported

extern UINT8 lm95245_addr[LM_SMB_ADDR_NUM];
