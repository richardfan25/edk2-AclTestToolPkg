...
#define DEVICEID_AMD_F17M11B0		0x15D0

#define SMN_ADDR_REG	0x60
#define SMN_DATA_REG	0x64

#define AMD17H_SMUTHM	0x59800

#define AMD17H_THM_TCON_CUR_TMP	0x00
#define AMD17H_THM_TCON_HTC		0x04
...
typedef struct _pci_bus_t
{
	...
	//----------------------------------
	// bit[0]   - init status (1=initialized)
	//----------------------------------
	uint32_t	status;
