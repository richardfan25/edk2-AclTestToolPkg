...
typedef enum
{
    ...
    //USER CONTROL GPIO
    DDevNo_AltGpio08 = 0xA0, //0xA0
    DDevNo_AltGpio09,        //0xA1
    DDevNo_AltGpio10,        //0xA2
    DDevNo_AltGpio11,        //0xA3
    DDevNo_AltGpio12,        //0xA4
    DDevNo_AltGpio13,        //0xA5
    DDevNo_AltGpio14,        //0xA6
    DDevNo_AltGpio15,        //0xA7
    //SMBUS
    DDevNo_SMBOEM4 = 0xA8, //0xA8, oem smbus4
    DDevNo_SMBOEM5,        //0xA9, oem smbus5
} eDynclDevNo;
/*==============================================================*/
typedef enum
{
